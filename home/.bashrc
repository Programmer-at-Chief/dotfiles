...
alias monkey="copy=$(cat ~/Desktop2/monkeytype.txt) && dbus-send --type=method_call --dest=org.kde.klipper /klipper org.kde.klipper.klipper.setClipboardContents string:$copy"
alias ctf="cd ~/Desktop2/CTF/"
...
export PATH="$HOME/bin/:$HOME/.emacs.d/bin:$PATH:/home/aman/.local/bin:/home/aman/.cargo/bin" # adding doom emacs to path
